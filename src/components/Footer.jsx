                    ...
                    <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <div className="text-gray-400 hover:text-white">First Link</div>
                                </li>
                                <li>
                                    <div className="text-gray-400 hover:text-white">Second Link</div>
                                </li>
                                <li>
                                    <div className="text-gray-400 hover:text-white">Third Link</div>
                                </li>
                                <li>
                                    <div className="text-gray-400 hover:text-white">Fourth Link</div>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
